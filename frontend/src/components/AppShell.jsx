...
// Icons — defined outside the component so their identity is stable across renders
...
const SidebarLink = ({ to, icon, children, collapsed, onLinkClick }) => (
  <NavLink
    to={to}
    className={({ isActive }) => `
        ...
        >
          ...
          <div className={appShellStyles.sidebarContainer}>
            <div>
              ...
              >
                <Link href="/" className={appShellStyles.logoLink}>
                  <div className="relative">
                    <img src="/logo.svg" alt="logo" className={appShellStyles.logoImage} />
                  ...
                  {!collapsed && (
                    <div className={appShellStyles.logoTextContainer}>
                      <span className={appShellStyles.logoText}>PromptToInvoice</span>
              ...
              <nav className={appShellStyles.nav}>
                <SidebarLink to="/app/dashboard" icon={<DashboardIcon />} collapsed={collapsed} onLinkClick={closeMobile}>
                  Dashboard
                </SidebarLink>
                <SidebarLink to="/app/invoices" icon={<InvoiceIcon />} collapsed={collapsed} onLinkClick={closeMobile}>
                  Invoices
                </SidebarLink>
                <SidebarLink to="/app/create-invoice" icon={<CreateIcon />} collapsed={collapsed} onLinkClick={closeMobile}>
                  Create Invoice
                </SidebarLink>
                <SidebarLink to="/app/business" icon={<ProfileIcon />} collapsed={collapsed} onLinkClick={closeMobile}>
                  Business Profile
                </SidebarLink>
              </nav>
            </div>
        ...
        <div className={appShellStyles.mobileOverlay}>
          ...
          <div className={appShellStyles.mobileSidebar}>
            <div className={appShellStyles.mobileHeader}>
              <Link href='/' className={appShellStyles.mobileLogoLink}
                onClick={() => setMobileOpen(false)}>
                <img src="/logo.svg" alt='logo' className={appShellStyles.mobileLogoImage} />
