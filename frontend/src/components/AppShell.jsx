...
// ── Icons (defined outside component to avoid "create components during render") ──
...
// SidebarLink extracted outside to avoid "create components during render".
// collapsed and setMobileOpen are passed as explicit props.
