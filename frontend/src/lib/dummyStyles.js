...
// src/lib/dummyStyles.js (add these to the existing export)
...
// Add to src/lib/dummyStyles.js (after the existing styles)
...
export const pricingCardStyles = {
  ...
  pricePopular: "bg-gradient-to-r from-rose-600 to-indigo-600 bg-clip-text",
